...
class AuthenticationBloc
  ...
  void _onAuthenticationStatusChanged(
    ...
    switch (event.status) {
      ...
      case AuthenticationStatus.authenticated:
        final user = await _tryGetUser(_authenticationRepository.username, _authenticationRepository.password);
  ...
  Future<AuthUser?> _tryGetUser(login, password) async {
    try {
      final user = await _userRepository.getUser(login, password);
      return user;
    } catch (_) {
      return null;
    }
